...
- Use conversation_history to resolve follow-up messages. Keep previous constraints such as budget, spice, allergies, diet, and delivery time unless the latest user_message clearly changes or cancels them. The latest user_message has priority when there is a conflict.
"""
